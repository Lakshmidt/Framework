...
public class SelectClassActions extends Genericmethods {
	//Genericmethods g=new Genericmethods();
	Select s;
	
	public void selectbyvalue(String value,String selectid)
	{
		s=new Select(findWebelement(selectid));
	...
	public List<WebElement> getalloptions(String selectelementkey)
	{
		s=new Select(findWebelement(selectelementkey));
		return s.getOptions();
	}
